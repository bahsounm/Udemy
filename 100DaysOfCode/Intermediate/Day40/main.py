...
users = data_man.get_custumer_emails()


cheapest_flights_found = {}
for code in iata_codes:
    cheapest_flight_found = flight_search.find_cheapest_offer(dest_loc_code =code,window_days=7)
...
notif_man.notify_by_phone(cheapest_flights_found)
notif_man.notify_by_email(cheapest_flights_found, users)
