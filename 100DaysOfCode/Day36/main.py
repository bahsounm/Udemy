...
STOCK_API_KEY = "HJ0ZZLCJKIAEG1B4"
NEWS_API_KEY = "6a18fbd1753f4cdeae5a1a209b11a0d7"
...
positive_diff = abs(float(day_before_yesterday_cp) - float(yesterdays_closing_price))
#TODO 4. - Work out the percentage difference in price between closing price yesterday and closing price the day before yesterday.
diff_percent = (positive_diff / float(yesterdays_closing_price))*100
...
formatted_articles = ['Headline: {}. \nBrief: {}'.format(article["title"],article["description"]) for article in three_articles]
